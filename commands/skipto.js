...
module.exports = {
  name: "skipto",
  description: `Bỏ qua đến một bài hát trong hàng chờ`,
  usage: "<number>",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    try {
      if (!args[0])
        return client.sendTime(
          message.channel,
          `**Sử dụng**: \`${GuildDB.prefix}skipto [số thứ tự bài hát mà muốn đến]\``
        );
      ...
      client.sendError(message.channel, "Có gì đó đã xảy ra.");
    }
  },
  SlashCommand: {
    options: [
