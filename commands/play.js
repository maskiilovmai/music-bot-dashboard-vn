...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!SearchString)
      return client.sendTime(
        message.channel,
        `**Sử dụng - **\`${GuildDB.prefix}play [tên bài hát]\``
      );
      ...
      if (SearchString.match(client.Lavasfy.spotifyPattern)) {
        ...
        if (Searched.loadType === "PLAYLIST_LOADED") {
          ...
          SongAddedEmbed.setAuthor(
            `Danh sách đã được thêm vào hàng chờ`,
          ...
          SongAddedEmbed.setDescription(
            `\**Bài hát: **\[${Searched.tracks[0].info.title}](${Searched.tracks[0].info.uri})`
          );
          SongAddedEmbed.addField(
            "Tác giả",
          ...
          SongAddedEmbed.addField("Yêu cầu bởi", Searched.tracks[0].requester, true);
        ...
        if (Searched.loadType === "NO_MATCHES")
          ...
          SongAddedEmbed.setThumbnail(Searched.tracks[0].displayThumbnail());
          SongAddedEmbed.setDescription(
            `\**Bài hát: **\[${Searched.tracks[0].title}](${Searched.tracks[0].uri})`
          );
