...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    let Embed = new MessageEmbed()
      .setAuthor(
        `Bảng lệnh của ${client.user.username}`,
      ...
      .setFooter(
        `Để nhận thông tin của từng loại lệnh hãy nhập ${
          GuildDB ? GuildDB.prefix : client.botconfig.DefaultPrefix
        }help [lệnh] | Chúc bạn có một ngày tốt lành!`
      ).setDescription(`${Commands.join("\n")}
  
  Discord Music Bot Version: v${require("../package.json").version}
  [✨ Máy Chủ Hỗ Trợ](${
    client.botconfig.SupportServer
  }) | [GitHub](https://github.com/maskiilovmai) | [Bảng điều khiển](${client.botconfig.Website}) | Bởi [Maskiiov Mai](https://github.com/maskiilovmai)`);
